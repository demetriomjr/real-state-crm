/*
  ...
  - You are about to drop the `user_prompt_feedbacks` table. If the table is not empty, all the data it contains will be lost.

*/
-- AlterTable
ALTER TABLE "chats" ALTER COLUMN "last_message_at" DROP NOT NULL,
ALTER COLUMN "last_message_at" DROP DEFAULT;

-- DropTable
DROP TABLE "user_prompt_feedbacks";
