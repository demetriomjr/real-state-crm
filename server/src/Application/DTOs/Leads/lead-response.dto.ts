...
export class AddressResponseDto {
  ...
  @ApiProperty({ description: 'User who last updated this record', required: false })
  updated_by?: string;

  @ApiProperty({ description: 'Deletion timestamp (soft delete)', required: false })
  deleted_at?: Date;
...
export class LeadResponseDto {
  ...
  // Sub-tables
  @ApiProperty({ description: 'Additional addresses', type: [AddressResponseDto] })
  addresses: AddressResponseDto[];

  @ApiProperty({ description: 'Additional contacts', type: [ContactResponseDto] })
  contacts: ContactResponseDto[];

  @ApiProperty({ description: 'Additional documents', type: [DocumentResponseDto] })
