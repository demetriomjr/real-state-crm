...
export class LeadUpdateDto {
  ...
  @ApiProperty({ description: 'Type of lead', enum: ['customer', 'prospect'], required: false })
  @IsOptional()
  @IsString()
  @IsIn(['customer', 'prospect'])
  lead_type?: string;

  @ApiProperty({ description: 'Status of the lead', enum: ['new', 'contacted', 'qualified', 'won', 'lost'], required: false })
  @IsOptional()
  @IsString()
  @IsIn(['new', 'contacted', 'qualified', 'won', 'lost'])
  lead_status?: string;

  @ApiProperty({ description: 'Temperature of the lead', enum: ['hot', 'warm', 'cold'], required: false })
  @IsOptional()
  @IsString()
  @IsIn(['hot', 'warm', 'cold'])
  lead_temperature?: string;

  @ApiProperty({ description: 'Origin of the lead', enum: ['website', 'email', 'phone', 'whatsapp', 'cellphone', 'other'], required: false })
  @IsOptional()
  @IsString()
  ...
  @ApiProperty({ description: 'Notes about the lead', type: [String], required: false })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  lead_notes?: string[];

  @ApiProperty({ description: 'ID of the user who first contacted this lead', required: false })
  @IsOptional()
  @IsUUID()
