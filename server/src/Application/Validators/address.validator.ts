...
export class AddressValidator {
  ...
  async validateCreate(data: any): Promise<void> {
    ...
    if (!data.address_line_1 || typeof data.address_line_1 !== 'string') {
      throw new BadRequestException('Address line 1 is required and must be a string');
    }
    ...
    if (data.address_line_1.length > 200) {
      throw new BadRequestException('Address line 1 must not exceed 200 characters');
    }
    ...
    if (!data.zip_code || typeof data.zip_code !== 'string') {
      throw new BadRequestException('ZIP code is required and must be a string');
    }
    ...
    if (data.district !== undefined && data.district !== null) {
      ...
      if (data.district.length > 100) {
        throw new BadRequestException('District must not exceed 100 characters');
      }
    }
    ...
    if (data.address_line_2 !== undefined && data.address_line_2 !== null) {
      ...
      if (data.address_line_2.trim() === '') {
        throw new BadRequestException('Address line 2 cannot be empty if provided');
      }

      if (data.address_line_2.length > 200) {
        throw new BadRequestException('Address line 2 must not exceed 200 characters');
      }
    }
