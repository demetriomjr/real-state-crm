...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Access denied - Developer level required' }),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', description: 'Business ID (UUID) - must match tenant_id from request' }),
