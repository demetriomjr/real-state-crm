...
- Orçamento (Budget) e conversão de perfil: primeiro Orçamento marca a Pessoa como “Cliente”.
- Negócio (Deal) simples com valor/etapa.
...
Nota P1 (perfil): criar o primeiro Orçamento para a pessoa converte o perfil para “Cliente” (irreversível para histórico).
...
- Nota P1: Perfil derivado (Cliente) a partir do primeiro Orçamento associado à pessoa.
